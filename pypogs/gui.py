...
DEG = chr(176) # Degree (unicode) character
    #original text below starts
# NONE = 0
# STAR_OL = 1
# COARSE_CCL = 2
# FINE_FCL = 3
    #original text below ends

    #edit by martynas starts
NONE = 0
STAR_OL = 1
COARSE_CCL = 3
FINE_FCL = 2
    #edit by martynas ends
class GUI:
...
class LiveViewFrame(ttk.Frame):
    ...
    def clear_tracker_callback(self): #call back yra mygtukas kuri paspaudi ant GUI ir tada numeta i sita funkcija
    ...
    def clear_offset_callback(self):
        ...
        cam = self.camera_variable.get() # cia atiduoda kintamaji siuo atevju (2)
        if cam == COARSE_CCL:
    ...
    def click_canvas_callback(self, event): # sis mygtukas reiskia: paspaudi ant GUI juodo ekranto ir tada nukreipia ten
